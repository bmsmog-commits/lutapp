...
class BibleVerseSeeder extends Seeder
{
    ...
    {
        $translation = BibleTranslation::where('code', 'KJV')->firstOrFail();

        $genesis = BibleBook::where('name', 'Genesis')->firstOrFail();
        ...
        $this->command->info('Genesis 1 KJV imported successfully: 31 verses.');
    }
}